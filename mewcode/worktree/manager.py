...
_GITIGNORE_LINES = (".mewcode/worktrees/", ".mewcode/worktree_session.json")
...
class Manager:
    ...
    def __init__(self, repo_root: str, cfg: WorktreesConfig) -> None:
        ...
        self.cfg = cfg
        self.worktree_dir = Path(self.repo_root) / ".mewcode" / "worktrees"
        self.session_file = Path(self.repo_root) / ".mewcode" / "worktree_session.json"

...
与 hooks/agents/worktrees 同目录族：`.mewcode/config.local.yaml` /
`.mewcode/config.yaml` / `~/.mewcode/config.yaml`，`features:` 键局部优先。
"""
...
_FEATURES_FILE_LOCAL = ".mewcode/config.local.yaml"
_FEATURES_FILE_PROJECT = ".mewcode/config.yaml"
_FEATURES_FILE_USER = "~/.mewcode/config.yaml"

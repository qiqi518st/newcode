...
HOOK_FILE_LOCAL = ".newcode/config.local.yaml"  # 本地（最高优先级），与权限 permissions.local.yaml 对齐
HOOK_FILE_PROJECT = ".newcode/config.yaml"  # 项目级
HOOK_FILE_USER = os.path.expanduser("~/.newcode/config.yaml")  # 用户级

...
# 规则文件路径常量
RULE_FILE_USER = os.path.expanduser("~/.config/newcode/permissions.yaml")
RULE_FILE_PROJECT = ".newcode/permissions.yaml"
RULE_FILE_LOCAL = ".newcode/permissions.local.yaml"

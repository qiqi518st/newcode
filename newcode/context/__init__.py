...
依赖边界：依赖 newcode.provider.base（Message/ToolCall/ToolResult/TokenUsage/Provider/
ToolDefinition）、newcode.conversation.manager、newcode.prompt.assembler（PromptPayload）、
newcode.llm（PromptTooLongError 哨兵）、newcode.utils.error 与标准库；

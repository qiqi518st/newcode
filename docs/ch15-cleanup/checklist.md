# MewCode ch15 收尾 - 团队清理引导与孤儿 Worktree 自动清扫 Checklist
...
- [ ] `git worktree remove .mewcode/worktrees/team-demo+alice`（团队存在）→ 拦截（验证：单测）
